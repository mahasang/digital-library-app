...
export const translations = {
  ...
  detail_related: {
    lo: "ງານວິໄຈທີ່ກ່ຽວຂ້ອງ",
    th: "งานวิจัยที่เกี่ยวข้อง",
    en: "Related research",
    vi: "Liên quan",
  },
  detail_read_pdf: {
  ...
  rating_login: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອໃຫ້ຄະແນນ",
    th: "เข้าสู่ระบบเพื่อให้คะแนน",
    en: "Login to rate",
    vi: "Đăng nhập để đánh giá",
  },
  ...
  comment_login: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອຄຳເຫັນ",
    th: "เข้าสู่ระบบเพื่อแสดงความเห็น",
    en: "Login to comment",
    vi: "Đăng nhập để bình luận",
  },
  comment_empty: {
    lo: "ຍັງບໍ່ມີຄຳເຫັນ",
  ...
  login_subtitle: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອເຂົ້າເຖິງງານວິໄຈ",
    th: "เข้าสู่ระบบเพื่อเข้าถึงงานวิจัย",
    en: "Sign in to access research",
    vi: "Đăng nhập để truy cập",
  },
  login_btn: {
    lo: "ເຂົ້າສູ່ລະບົບ",
    th: "เข้าสู่ระบบ",
  ...
  register_subtitle: {
    lo: "ສະໝັກສະມາຊິກເພື່ອເຂົ້າເຖິງງານວິໄຈ ແລະ ຟີເຈີເພີ່ມເຕີມ",
    th: "สมัครสมาชิกเพื่อเข้าถึงงานวิจัยและฟีเจอร์เพิ่มเติม",
    en: "Register to access research and more features",
    vi: "Đăng ký để truy cập nghiên cứu",
  },
  register_btn: {
    lo: "ສະໝັກສະມາຊິກ",
    th: "สมัครสมาชิก",
  ...
  account_guest: {
    lo: "ຍັງບໍ່ໄດ້ເຂົ້າສູ່ລະບົບ",
    th: "ยังไม่ได้เข้าสู่ระบบ",
    en: "Not signed in",
    vi: "Chưa đăng nhập",
  },
  account_guest_sub: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອເຂົ້າເຖິງລາຍການທີ່ມັກ ແລະ ປະຫວັດການອ່ານ",
    th: "เข้าสู่ระบบเพื่อเข้าถึงรายการโปรดและประวัติการอ่าน",
    en: "Sign in to access favorites and reading history",
    vi: "Đăng nhập để xem yêu thích và lịch sử",
  },
  account_history: {
    lo: "ປະຫວັດການອ່ານ",
    th: "ประวัติการอ่าน",
  ...
  account_logout_q: {
    lo: "ທ່ານຕ້ອງການອອກຈາກລະບົບບໍ?",
    th: "ต้องการออกจากระบบไหม?",
    en: "Sign out?",
    vi: "Bạn muốn đăng xuất?",
  },
  account_edit: {
    lo: "ແກ້ໄຂໂປຣໄຟລ",
    th: "แก้ไขโปรไฟล์",
  ...
  account_avatar_permission: {
    lo: "ກະລຸນາອະນຸຍາດເຂົ້າເຖິງຮູບພາບ",
    th: "กรุณาอนุญาตให้เข้าถึงรูปภาพ",
    en: "Please allow photo library access",
    vi: "Vui lòng cho phép truy cập thư viện ảnh",
  },
  account_avatar_error: {
    lo: "ອັບໂຫລດຮູບໂປຣໄຟລ໌ບໍ່ສຳເລັດ",
    th: "อัปโหลดรูปโปรไฟล์ไม่สำเร็จ",
    en: "Failed to upload avatar",
    vi: "Tải ảnh đại diện lên thất bại",
  },
  account_no_name: {
    lo: "ບໍ່ລະບຸຊື່",
    th: "ไม่ระบุชื่อ",
  ...
  // ── Favorites ──
  fav_empty_title: {
    lo: "ຍັງບໍ່ມີລາຍການທີ່ມັກ",
    th: "ยังไม่มีรายการโปรด",
    en: "No favorites yet",
    vi: "Chưa có yêu thích",
  },
  fav_empty_text: {
    lo: "ກົດ ❤️ ໃນໜ້າລາຍລະອຽດ ເພື່ອບັນທຶກ",
    th: "กด ❤️ ในหน้ารายละเอียด เพื่อบันทึก",
    en: "Tap ❤️ on a research to save",
    vi: "Nhấn ❤️ để lưu nghiên cứu",
  },
  fav_search: {
    lo: "ຄົ້ນຫາງານວິໄຈ",
    th: "ค้นหางานวิจัย",
  ...
  fav_login: {
    lo: "ເຂົ້າສູ່ລະບົບກ່ອນ",
    th: "เข้าสู่ระบบก่อน",
    en: "Please sign in",
    vi: "Vui lòng đăng nhập",
  },
  fav_login_text: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອເບິ່ງລາຍການທີ່ມັກ",
    th: "เข้าสู่ระบบเพื่อดูรายการโปรด",
    en: "Sign in to view favorites",
    vi: "Đăng nhập để xem yêu thích",
  },
  ...
  fav_remove_q: {
    lo: "ທ່ານຕ້ອງການລຶບອອກຈາກລາຍການທີ່ມັກບໍ?",
    th: "ต้องการลบออกจากรายการโปรด?",
  ...
  history_clear_q: {
    lo: "ທ່ານຕ້ອງການລົບປະຫວັດການອ່ານທັງໝົດບໍ?",
    th: "ต้องการลบประวัติการอ่านทั้งหมด?",
    en: "Clear all reading history?",
    vi: "Xóa toàn bộ lịch sử đọc?",
  },
  history_empty_title: {
    lo: "ຍັງບໍ່ມີປະຫວັດການອ່ານ",
    th: "ยังไม่มีประวัติการอ่าน",
    en: "No reading history",
    vi: "Chưa có lịch sử đọc",
  },
  history_empty_text: {
    lo: "ງານວິໄຈທີ່ທ່ານເປີດອ່ານຈະຖືກບັນທຶກໄວ້ທີ່ນີ້",
    th: "งานวิจัยที่คุณเปิดอ่านจะถูกบันทึกไว้ที่นี่",
    en: "Research you read will appear here",
    vi: "Nghiên cứu bạn đọc sẽ xuất hiện ở đây",
  },
  history_remove_q: {
    lo: "ທ່ານຕ້ອງການລຶບອອກຈາກປະຫວັດການອ່ານບໍ?",
    th: "ต้องการลบออกจากประวัติการอ่าน?",
  ...
  notif_empty: {
    lo: "ບໍ່ມີການແຈ້ງເຕືອນ",
    th: "ไม่มีการแจ้งเตือน",
    en: "No notifications",
    vi: "Không có thông báo",
  },
  notif_login: {
    lo: "ເຂົ້າສູ່ລະບົບເພື່ອເບິ່ງການແຈ້ງເຕືອນ",
  ...
  common_pdf_error: {
    lo: "ບໍ່ສາມາດໂຫລດ PDF ໄດ້",
    th: "ไม่สามารถโหลด PDF ได้",
    en: "Cannot load PDF",
    vi: "Không thể tải PDF",
  },
  common_pdf_retry: { lo: "ລອງໃໝ່", th: "ลองใหม่", en: "Retry", vi: "Thử lại" },
  common_forgot_msg: {
    lo: "ກະລຸນາຕິດຕໍ່ຜູ້ດູແລລະບົບ ຫຼື ສົ່ງອີເມວ info@digitallibrary.la",
    th: "กรุณาติดต่อผู้ดูแลระบบหรือส่งอีเมล info@digitallibrary.la",
    en: "Please contact admin or email info@digitallibrary.la",
    vi: "Vui lòng liên hệ quản trị viên",
  },
  common_no_user: {
    lo: "ບໍ່ພົບຂໍ້ມູນຜູ້ໃຊ້",
    th: "ไม่พบข้อมูลผู้ใช้",
    en: "User not found",
    vi: "Không tìm thấy người dùng",
  },
  common_save_error: {
    lo: "ບໍ່ສາມາດບັນທຶກໂປຣໄຟລໄດ້",
    th: "ไม่สามารถบันทึกโปรไฟล์ได้",
    en: "Cannot save profile",
    vi: "Không thể lưu hồ sơ",
  },
  common_pw_error: {
    lo: "ບໍ່ສາມາດປ່ຽນລະຫັດຜ່ານໄດ້",
    th: "ไม่สามารถเปลี่ยนรหัสผ่านได้",
    en: "Cannot change password",
    vi: "Không thể đổi mật khẩu",
  },
  common_auth_error: {
    lo: "ບໍ່ສາມາດຢືນຢັນຕົວຕົນໄດ້",
    th: "ไม่สามารถยืนยันตัวตนได้",
    en: "Cannot verify identity",
    vi: "Không thể xác thực",
  },
  common_pw_changed: {
    lo: "ປ່ຽນລະຫັດຜ່ານສຳເລັດ",
    th: "เปลี่ยนรหัสผ่านสำเร็จ",
    en: "Password changed successfully",
    vi: "Đổi mật khẩu thành công",
  },
  common_pw_wrong: {
    lo: "ລະຫັດຜ່ານປັດຈຸບັນບໍ່ຖືກຕ້ອງ",
    th: "รหัสผ่านปัจจุบันไม่ถูกต้อง",
    en: "Current password is incorrect",
    vi: "Mật khẩu hiện tại không đúng",
  },
  common_pw_req: {
    lo: "ກະລຸນາປ້ອນລະຫັດຜ່ານປັດຈຸບັນ",
    th: "กรุณากรอกรหัสผ่านปัจจุบัน",
    en: "Please enter current password",
    vi: "Vui lòng nhập mật khẩu hiện tại",
  },
  common_comment_error: {
    lo: "ບໍ່ສາມາດສົ່ງຄຳເຫັນໄດ້",
    th: "ไม่สามารถส่งความคิดเห็นได้",
    en: "Cannot send comment",
    vi: "Không thể gửi bình luận",
  },
  common_rating_error: {
    lo: "ບໍ່ສາມາດບັນທຶກຄະແນນໄດ້",
    th: "ไม่สามารถบันทึกคะแนนได้",
    en: "Cannot save rating",
    vi: "Không thể lưu đánh giá",
  },
  ...
  contact_sub: {
    lo: "ມີຄຳຖາມຫຼືຕ້ອງການຊ່ວຍເຫຼືອ?",
    th: "มีคำถามหรือต้องการความช่วยเหลือ?",
    en: "Have questions or need help?",
    vi: "Có câu hỏi hoặc cần hỗ trợ?",
  },
  contact_channels: {
    lo: "ຊ່ອງທາງຕິດຕໍ່",
    th: "ช่องทางติดต่อ",
  ...
  contact_vientiane: {
    lo: "ວຽງຈັນ, ສປປ ລາວ",
    th: "เวียงจันทน์, สปป.ลาว",
    en: "Vientiane, Lao PDR",
    vi: "Viêng Chăn, CHDCND Lào",
  },
  ...
  auth_verified: {
    ...
    th: "ยืนยันสำเร็จ",
    en: "Verified!",
    vi: "Xác nhận thành công!",
  },
  auth_verify_failed: {
    lo: "ການຢືນຢັນລົ້ມເຫລວ",
    th: "การยืนยันล้มเหลว",
    en: "Verification failed",
    vi: "Xác nhận thất bại",
  },
  auth_email_confirmed: {
    lo: "ຢືນຢັນອີເມວສຳເລັດ ກະລຸນາເຂົ້າສູ່ລະບົບ",
    th: "ยืนยันอีเมลสำเร็จ กรุณาเข้าสู่ระบบ",
    en: "Email confirmed. Please sign in.",
    vi: "Xác nhận email thành công. Vui lòng đăng nhập.",
  },
  ...
  // ── Forgot Password ──
  forgot_title:      { lo: 'ລືມລະຫັດຜ່ານ',           th: 'ลืมรหัสผ่าน',          en: 'Forgot password',        vi: 'Quên mật khẩu' },
  forgot_sub:        { lo: 'ປ້ອນອີເມວເພື່ອຮັບລິ້ງລີເຊັດ', th: 'กรอกอีเมลเพื่อรับลิงก์รีเซ็ต', en: 'Enter your email to receive a reset link', vi: 'Nhập email để nhận link đặt lại' },
