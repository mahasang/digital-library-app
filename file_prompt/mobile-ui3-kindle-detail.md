# Mobile App — Phase UI-3: Kindle-style Detail Page Redesign
...
## Layout ใหม่ (Kindle Store style)

```
┌─────────────────────────────┐
│ ← back    share  ❤️ count   │  ← floating header บนรูป
├──────────┬──────────────────┤
│          │ ชื่อหนังสือ       │
│  ปก      │ ชื่อภาษาอังกฤษ   │  ← hero row (ปกซ้าย, info ขวา)
│  140x196 │ ● สาธารณะ        │
│          │ 4.4 ★ (1 ຄະແນນ) │
│          │ 👁 389  ⬇ 95     │
├──────────┴──────────────────┤
│  [   ອ່ານ PDF ອອນລາຍ   ]   │  ← ปุ่มใหญ่เต็มความกว้าง
├─────────────────────────────┤
│ ┌──────┬──────┬──────┬────┐ │
│ │ ปี   │หน้า  │หน่วย │ประ │ │  ← details grid 4 ช่อง
│ │ 2024 │ N/A  │ ຄະນະ │ IT │ │
│ └──────┴──────┴──────┴────┘ │
├─────────────────────────────┤
│ [ບົດຄັດຫຍໍ້] [ຄຳເຫັນ (1)]  │  ← tabs
├─────────────────────────────┤
│  Tab content (abstract/     │
│  comments)                  │
└─────────────────────────────┘
```
...
Phase UI-3: full replace ตามโค้ดด้านบน — Kindle-style detail page
- Layout ใหม่: sticky header + hero row (ปกซ้าย+info ขวา) + PDF button
- Details grid: 4 ช่อง (ปี, หน่วยงาน, หมวด, ❤️)
- Tabs: ບົດຄັດຫຍໍ້ / ຄຳເຫັນ (rating + comments ย้ายมาที่นี่)
ห้ามแตะไฟล์อื่น
```
...
2. Hero row — ปกซ้าย info ขวา (ชื่อ + badge + rating + stats)
3. Details grid — 4 ช่อง มี border แนวตั้งคั่น
4. Tabs — กด ຄຳເຫັນ → แสดง rating + comment
5. Tabs — กด ບົດຄັດຫຍໍ້ → แสดง abstract + keywords + related
6. Sticky header — ชื่อย่อ + back + share + heart
